...
USE InfoPosto
GO 
CREATE TABLE tbFaleConosco(Codigo int identity Primary key,Nome VARCHAR(50), Email VARCHAR(100), Mensagem VARCHAR(1000),Resposta VARCHAR(1000),DataResposta DATETIME)
GO
